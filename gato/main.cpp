...
int main (){
	...
	do{
		...
		mostrarGato(tablero);
		cout << nombre[cont] << " posicion de tu signo [x]";
		cin >> eleccionX;
		cout << nombre[cont] << " posicion de tu signo [Y]";
		cin >> eleccionY;

		if(eleccionX<=3 && eleccionY<=3 && tablero[eleccionY-1][eleccionX-1]==' '){
			tiros++;
			if(cont==0){
				tablero[eleccionY-1][eleccionX-1]='O';
				...
				tablero[eleccionY-1][eleccionX-1]='X';
